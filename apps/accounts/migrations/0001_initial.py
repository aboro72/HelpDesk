    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('team_leader', 'Team Leader'), ('support_agent', 'Support Agent'), ('customer', 'Customer')], db_index=True, default='customer', max_length=20, verbose_name='role')),
